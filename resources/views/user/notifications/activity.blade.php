...
@push('styles')
<!-- Link css user/notifications/activity -->
<link href="{{ asset('/css/user/notifications/activity.css') }}" rel="stylesheet">
@endpush
...
@push('scripts')
<!-- Link script user/notifications/activity -->
<script src="{{ asset('/js/user/notifications/activity.js') }}"></script>
@endpush