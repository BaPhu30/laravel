...
@push('styles')
<!-- Link css user/notifications/promotion -->
<link href="{{ asset('/css/user/notifications/promotion.css') }}" rel="stylesheet">
@endpush
...
@push('scripts')
<!-- Link script user/notifications/promotion -->
<script src="{{ asset('/js/user/notifications/promotion.js') }}"></script>
@endpush