...
@push('styles')
<!-- Link css user/notifications/rating -->
<link href="{{ asset('/css/user/notifications/rating.css') }}" rel="stylesheet">
@endpush
...
<div class="main__account--wrapper container">
    <div class="main__account container d-flex justify-content-between py-3">
        <div class="main__account--nav">
            ...
            <a href="{{route('user.notifications.wallet')}}" class="main__account--nav-items d-flex justify-content-between align-items-center text-dark mb-3">
                <div class="main__account--nav-items-img me-2"></div>
                <div class="main__account--nav-items-title account">
                    Cập Nhật Ví
                </div>
        ...
        <div class="main__account--main card py-3 px-4">
            <div class="main__account--main-content d-flex justify-content-center align-items-center">
                <div class="main__account--main-content-img">
                    <img src="{{ asset('/img/user/notifications/user-notifications-2.png') }}" alt="">
                </div>
                Chưa có cập nhật về Đánh giá
            </div>
        </div>
    </div>
</div>
...
@push('scripts')
<!-- Link script user/notifications/rating -->
<script src="{{ asset('/js/user/notifications/rating.js') }}"></script>
@endpush