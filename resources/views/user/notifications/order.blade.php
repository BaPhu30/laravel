...
@push('styles')
<!-- Link css user/notifications/order -->
<link href="{{ asset('/css/user/notifications/order.css') }}" rel="stylesheet">
@endpush
...
@push('scripts')
<!-- Link script user/notifications/order -->
<script src="{{ asset('/js/user/notifications/order.js') }}"></script>
@endpush