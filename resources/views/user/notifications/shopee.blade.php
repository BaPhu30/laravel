...
@push('styles')
<!-- Link css user/notifications/shopee -->
<link href="{{ asset('/css/user/notifications/shopee.css') }}" rel="stylesheet">
@endpush
...
@push('scripts')
<!-- Link script user/notifications/shopee -->
<script src="{{ asset('/js/user/notifications/shopee.js') }}"></script>
@endpush