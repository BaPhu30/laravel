...
window.addEventListener("load", function () {
    const categorySliderMain = document.querySelector(
        ".main__category--slider-main"
    );
    const categorySliderMainItem = document.querySelectorAll(
        ".main__category--slider-main-item"
    );
    const categorySliderPrev = document.querySelector(
        ".main__category--slider-prev"
    );
    const categorySliderNext = document.querySelector(
        ".main__category--slider-next"
    );
...
// Slider flashsale
window.addEventListener("load", function () {
    const flashsaleSliderMain = document.querySelector(
        ".main__flashsale--slider-main"
    );
    const flashsaleSliderMainItem = document.querySelectorAll(
        ".main__flashsale--slider-main-item"
    );
    const flashsaleSliderPrev = document.querySelector(
        ".main__flashsale--slider-prev"
    );
    const flashsaleSliderNext = document.querySelector(
        ".main__flashsale--slider-next"
    );
...
window.addEventListener("load", function () {
    const shopeeMallShopSliderMain = document.querySelector(
        ".main__shopeemall--slider-shop-main"
    );
    const shopeeMallShopSliderMainItem = document.querySelectorAll(
        ".main__shopeemall--slider-shop-main-item"
    );
    const shopeeMallShopSliderPrev = document.querySelector(
        ".main__shopeemall--slider-shop-prev"
    );
    const shopeeMallShopSliderNext = document.querySelector(
        ".main__shopeemall--slider-shop-next"
    );
...
window.addEventListener("load", function () {
    const flashsaleSliderMain = document.querySelector(
        ".main__topsearch--slider-main"
    );
    const flashsaleSliderMainItem = document.querySelectorAll(
        ".main__topsearch--slider-main-item"
    );
    const flashsaleSliderPrev = document.querySelector(
        ".main__topsearch--slider-prev"
    );
    const flashsaleSliderNext = document.querySelector(
        ".main__topsearch--slider-next"
    );
    flashsaleSliderPrev.style = "display: none";
    const widthSlider = flashsaleSliderMainItem[0].offsetWidth * 5;
    let positionX = 0;
